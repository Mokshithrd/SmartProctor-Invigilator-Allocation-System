...
const insert = () => {
    ...
    const users = [
        ...
        { name: "Faculty1", email: "faculty1@example.com", password: "Faculty1@123", role: "Faculty", designation: "Assistant Professor" },
        { name: "Faculty2", email: "faculty2@example.com", password: "Faculty2@123", role: "Faculty", designation: "Assistant Professor" },
        ...
        { name: "Faculty7", email: "faculty7@example.com", password: "Faculty7@123", role: "Faculty", designation: "Professor" },
