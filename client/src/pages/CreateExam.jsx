...
const CreateExam = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const roomsRes = await axios.get("http://localhost:4000/room/all", { withCredentials: true });
        const facultyRes = await axios.get("http://localhost:4000/faculty/all", { withCredentials: true });
